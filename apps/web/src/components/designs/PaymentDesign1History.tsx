      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-6 p-6">
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant="outline"
                className="border-emerald-200 bg-emerald-100 px-3 py-1 text-sm text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300"
              >
                Active
              </Badge>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm sm:grid-cols-3">
              ...
              <div>
                ...
                <p className="font-semibold text-foreground">
                  {formatDate(sub.dateCreated)}
                </p>
              </div>
              <div>
                <p className="mb-1 text-xs text-muted-foreground">Renews</p>
                <p className="font-semibold text-foreground">
                  {sub.expiredAt ? formatDate(sub.expiredAt) : "—"}
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            {
              label: "Avg / Month",
              value: `$${(totalPaid / Math.max(paidPayments.length, 1)).toFixed(2)}`,
            },
          ].map((s) => (
            <div
              key={s.label}
                        ...
                        <Badge
                          ...
                          className={
                            p.amount === 0
                              ...
                              : "border-emerald-200 bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300"
                          }
                        >
